    ...
    const [isMouseInside, setIsMouseInside] = useState(false)
        ...
        <div className="modal-screen">
            ...
            <div className="modal-modify">
                ...
                {
                    modalSelected ? <img className='modal-publish-image' alt="post" src={src} onMouseEnter={() => setIsMouseInside(true)} onMouseLeave={() => setIsMouseInside(false)}/> : <div className="image_replacement" alt="remplacement"></div> 
                }
                {
                ...
                <label htmlFor="modal_image_button" className="modal_image_button">Ajouter une image</label>
